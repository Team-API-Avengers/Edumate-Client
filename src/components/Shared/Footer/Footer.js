...
// import { BsBrowserEdge, BsFacebook, BsGeoAltFill,  BsInstagram, BsTwitter, BsWhatsapp} from "react-icons/bs";
...
const Footer = () => {
  ...
  return (
    <div>
      ...
      <footer aria-label="Site Footer" className="bg-white  dark:bg-[#350573]">
          ...
          <div className="mt-8 border-t border-gray-100 pt-8">
            <div className="sm:flex sm:justify-between">
              <p className="text-xs text-gray-500 dark:text-white">
                &copy; 2023. Team-API_Avengers. All rights reserved.
              </p>

              <nav aria-label="Footer Navigation - Support" className="mt-8 sm:mt-0">
                <ul className="flex flex-wrap dark:text-white justify-start gap-4 text-xs lg:justify-end">
                  <li>
