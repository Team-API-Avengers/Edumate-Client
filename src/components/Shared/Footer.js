      ...
      <footer aria-label="Site Footer" className="text-black dark:text-[#bb86fc]" style={{ background: "#04516B" }}>
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <ul className="mt-8 flex justify-center dark:text-[#bb86fc] gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-teal-300  dark:text-teal-300 transition hover:text-teal-700 "
                  >
            ...
            <div className="grid grid-cols-1 dark:text-gray-200 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              <div className="text-center sm:text-left dark:text-gray-200">
                <p className="text-lg font-medium text-gray-200  dark:text-gray-200">About Us</p>
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-200  dark:text-gray-200">Our Services</p>
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-200  dark:text-gray-200">Contact Us</p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      <svg
                        ...
                        className="h-5 w-5 shrink-0 text-gray-200  dark:text-gray-200"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-200  dark:text-gray-200">0123456789</span>
                    </a>
                  </li>
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-gray-500  dark:text-gray-200">
                ...
                <a
                  className="inline-block mx-3 text-gray-200 dark:text-gray-200 underline transition hover:text-gray-200/75"
                  href="/"
                >
                  Terms & Conditions
                </a>
              ...
              <p className="mt-4 text-sm text-gray-200  dark:text-gray-200 sm:order-first sm:mt-0">
