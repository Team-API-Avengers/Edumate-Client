...
const Sponsors = () => {
    return (
        <div>
            <h1 className='text-2xl text-start font-semibold mx-5 w-44 lg:mx-20 my-2 dark:bg-black dark:text-white bg-white text-gray-800 p-5 rounded-r-full'>Sponsors</h1>
            <div className='mx-5 lg:mx-20 dark:bg-black dark:text-white'>
            <marquee>
            <div className="flex">
