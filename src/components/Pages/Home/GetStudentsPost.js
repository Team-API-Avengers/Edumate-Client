    ...
    return (
        <div className='lg:mx-10 mx-5'>
            ...
            {/*TODO: Show All Post's Card */}
            {
                ...
                <article key={idx} className="rounded-xl my-3 hover:shadow-md shadow-slate-500 border-2 border-gray-100 bg-white">
                ...
                />
                  :  
                    ...
                    <div className="mt-2 sm:flex sm:items-center sm:gap-2">
                        <label htmlFor="commentModal" onClick={() => handleComment(post)} className="flex items-center gap-1 text-gray-500 cursor-pointer underline hover:text-gray-700">
                        <svg
