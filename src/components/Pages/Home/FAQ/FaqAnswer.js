      ...
      >
        ...
        <div className="">
          <h2 className="text-start mb-8 text-4xl font-bold mt-8">
            Frequently asked questions <br /> <span style={{ color: "#2CA01C" }}>Answer the question</span>
          </h2>
          <div tabIndex={0} className="collapse collapse-arrow border border-base-300  rounded-box mb-5 ">
            ...
            <div className="collapse-content bg-gradient-to-r from-green-300 to-teal-300 ...">
