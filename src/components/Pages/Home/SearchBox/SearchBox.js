...
const SearchBox = () => {
  ...
  return (
    <div>
      <form onSubmit={handleSearch} className="py-10  dark:bg-[#350573]  dark:text-white">
        ...
        />
        <button className="btn bg-blue-500 hover:bg-blue-600 border-0 rounded-none mt-6 lg:mt-0 ">Search</button>
      </form>
              ...
              {data?.map((value) => (
                <div class="max-w-2xl space-y-2 mx-auto">
                  <div class=" shadow-md border text-start border-gray-300 rounded-lg max-w-sm bg-indigo-200 dark:border-gray-300">
                    <img class="rounded-t-lg h-[201px] w-[300px]" src={value.image} alt="img" />
