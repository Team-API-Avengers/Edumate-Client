    ...
    <div>
      <div className="p-6 bg-white rounded-xl">
        <a href="#/" className="group">
          ...
          <h3
            className="mt-6 group-hover:text-purple-400 font-semibold text-xl lg:text-4xl line-clamp-3 transition translation-all duration-200 ease-in-out"
        ...
        <div className="mt-6">
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            <time
              ...
              dateTime="2021-11-06T08:29:56+00:00"
            >
              {date}
            </time>
            <a
              href="#/"
              className="inline-block text-gray-600 hover:text-purple-400"
            >
              {comment} Comments
            </a>
        ...
        <a
          href="#/"
          className="inline-block mt-6 text-purple-500 hover:text-purple-400"
        >
          Read More
        </a>
      </div>
      ...
      {/* <div class="relative max-w-sm rounded overflow-hidden shadow-lg">
        {" "}
        <img class="w-full h-56 object-cover" src={url} alt="Card image" />{" "}
        ...
        <div class=" inset-0 flex mb-6 items-center justify-center">
          ...
          <div class="bg-white rounded-lg p-6 transform hover:-translate-y-2 transition duration-500">
            ...
            <p class="text-gray-700">
              This is an example of an animated card created using Tailwind CSS.
            </p>{" "}
          </div>{" "}
        </div>{" "}
      </div> */}
