  ...
  return (
    <div className="mt-8">
      ...
      <div className=" max-w-screen-lg mt-10 mb-10 mx-auto grid grid-cols-1">
        <div class="container grid lg:grid-cols-4 grid-cols-2 gap-10 px-5 py-1 dark:text-[#350573]  mx-auto">
          <motion.div
            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
          ...
          >
            <Link to={"/Science"}>
              <div class=" grid grid-cols-1 hover:text-blue-500  border  hover:bg-white dark:bg-gray-200 border-gray-200 p-4 h-36   hover:border-blue-500 dark:hover:bg-blue-100 ">
                <div className="flex flex-col justify-center ">
                  <img className="w-14  mt-3 h-12  mx-auto" src={data} alt="" />
                  <div className="ml-5">
                    <h2 class="mt-2  text-xl mr-4 font-bold">Science</h2>
                  </div>
                </div>
                {/* <div className="-ml-6">
                  <IoIosArrowForward />
            ...
            <Link to={"/Commerce"}>
              <div class=" grid grid-cols-1 hover:text-blue-500  border  hover:bg-white dark:bg-gray-200 border-gray-200 p-4 h-36   hover:border-blue-500 dark:hover:bg-blue-100 ">
                <div className="flex flex-col justify-center ">
                  ...
                  <div className="ml-5">
                    <h2 class="mt-2  text-xl mr-4 font-bold">Commerce</h2>
                  </div>
                </div>
                {/* <div className="-ml-6">
                  <IoIosArrowForward />
            ...
            <Link to={"/Arts"}>
              <div class=" grid grid-cols-1 hover:text-blue-500  border  hover:bg-white dark:bg-gray-200 border-gray-200 p-4 h-36   hover:border-blue-500 dark:hover:bg-blue-100 ">
                <div className="flex flex-col justify-center ">
                  ...
                  <div className="ml-5">
                    <h2 class="mt-2  text-xl mr-4 font-bold">Arts</h2>
                  </div>
                </div>
                {/* <div className="-ml-6">
                  <IoIosArrowForward />
            ...
            <Link to={"/all-Teachers"}>
              <div class=" grid grid-cols-1 hover:text-blue-500  border  hover:bg-white dark:bg-gray-200 border-gray-200 p-4 h-36   hover:border-blue-500 dark:hover:bg-blue-100 ">
                <div className="flex flex-col justify-center ">
                  ...
                  <div className="ml-5">
                    <h2 class="mt-2  text-xl -ml-6 font-bold">
                      All Department
                    </h2>
                  </div>
                </div>
