...
const AddBlog = () => {
  ...
  return (
    <div>
      <section className=" py-1 bg-blueGray-50  dark:bg-[#350573]  ">
                  ...
                  <div className="w-full lg:w-6/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <input
                        ...
                        readOnly
                        required
                        className=" border-green-400 border px-3 py-3 placeholder-blueGray-300 text-blueGray-600 dark:text-[#000000] bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-full lg:w-12/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <textarea
                        ...
                        {...register("details")}
                        required
                        className=" border-green-400 border px-3 h-32 py-3 placeholder-blueGray-300 text-blueGray-600 dark:text-[#000000] bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      />
                    </div>
                  </div>
                </div>
