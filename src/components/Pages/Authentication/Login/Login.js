...
const Login = () => {
    return (
        <div>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-50 shadow-xl mx-auto">
	...
	<form novalidate="" action="" className="space-y-6 ">
		...
		<div className="space-y-1 text-sm">
			...
			<div className="flex items-center">
				<input type="checkbox" name="remember" id="remember" aria-label="Remember me" className="mr-1 bg-slate-100 rounded-sm  focus:ring-2 accent-violet-400" />
