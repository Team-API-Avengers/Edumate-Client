                ...
                <form onSubmit={handleSubmit(handleSignUp)} >
                    <div className="text-sm">
                        ...
                        <input type="text"
                            ...
                            placeholder="Name" name="name" className="input input-bordered w-full px-4 py-3 rounded-md  " />
                    </div>
                    ...
                    <div className="text-sm">
                        ...
                        })} placeholder="Email" name="email" className="input input-bordered w-full px-4 py-3 rounded-md  " />
                    ...
                    <div className="mt-3 ms-1 text-sm">
                        ...
                        })} placeholder="Password" name="password" className="input input-bordered w-full px-4 py-3 rounded-md  " />
                    ...
                    <div className="mt-3 ms-1 text-sm">
                        ...
                        })} placeholder="Number" name="phoneNumber" className="input input-bordered w-full px-4 py-3 rounded-md  " />
